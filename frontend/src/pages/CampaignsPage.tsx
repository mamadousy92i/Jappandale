...
function CampaignsPage() {
  ...
  const showMine =
    user?.role === "PORTEUR" && searchParams.get("vue") === "mes-campagnes";
          ...
          <div className="flex shrink-0 flex-wrap gap-3">
            {user?.role === "PORTEUR" && (
              <Button
                asChild
                variant="outline"
                className="h-11 rounded-full border-black/10 px-5 text-ink hover:border-gold hover:bg-gold/10"
              >
                <Link
            ...
            {((user?.role === "PORTEUR" && !showMine) || !user) && (
              ...
              >
                <Link
                  to={
                    user ? "/campagnes/nouvelle" : "/inscription?role=PORTEUR"
                  }
                >
            ...
            <div className="mt-10 border-y border-black/10 py-7">
              ...
              >
                <button
                  ...
                  className={`min-h-11 rounded-full px-4 py-2 text-sm font-medium transition-all outline-none focus-visible:ring-2 focus-visible:ring-gold-dark/50 ${
                    category === null
