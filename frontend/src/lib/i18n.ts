...
import campaignDetailEn from "@/locales/en/campaignDetail.json"
...
import createCampaignEn from "@/locales/en/createCampaign.json"
...
import reportCampaignEn from "@/locales/en/reportCampaign.json"
...
import passportVerificationEn from "@/locales/en/passportVerification.json"

export const SUPPORTED_LANGUAGES = ["fr", "wo", "it", "es", "en"] as const
...
void i18n
  ...
  .init({
    ...
    resources: {
      ...
      en: { help: helpEn, common: commonEn, campaigns: campaignsEn, about: aboutEn, contact: contactEn, campaignDetail: campaignDetailEn, auth: authEn, account: accountEn, activity: activityEn, createCampaign: createCampaignEn, reportCampaign: reportCampaignEn, passportVerification: passportVerificationEn },
    },
