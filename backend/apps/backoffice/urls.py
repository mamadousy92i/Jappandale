...
from .views import (
    ...
    ContributionShareholderDecisionView,
    DashboardView,
    DisputeReviewView,
    KycDocumentFileView,
    KycDecisionView,
...
urlpatterns = [
    ...
    path("contributions/<int:contribution_id>/actionnariat/", ContributionShareholderDecisionView.as_view(), name="contribution-shareholder-decision"),
    ...
    path("scores/<int:user_id>/override/", ScoreOverrideView.as_view(), name="score-override"),
